...
# ... (les fonctions registration_request, login_request, logout_request, check_if_enrolled restent inchangées)
...
def show_exam_result(request, course_id, submission_id):
    ...
    if total_questions > 0:
        score_percentage = int((len(correct_choices) / total_questions) * 100)
    else:
        score_percentage = 0
        
    passed = score_percentage >= 50 # On considère réussite à partir de 50%
